            ...
            >
              ...
              <div className="grid grid-cols-3 gap-4">
                {technicalSkills.map((skill) => (
                  ...
                  >
                    <img src={skill.logo} alt={skill.name} className="w-10 h-10" style={{ filter: 'brightness(0) invert(1) sepia(1) saturate(10) hue-rotate(310deg) drop-shadow(0 0 4px hsl(350, 80%, 65%)) drop-shadow(0 0 8px hsl(350, 80%, 65%))' }} />
